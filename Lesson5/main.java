...
public class main {
    ...
    public static void main(String[] vma) {
        ...
        System.out.println(f_removeDuplicatesRegex("qwezrty1122qwerty33445566778899qwerty"));
        System.out.println(f_anagram("Kot", "tOK"));
        System.out.println(f_compareTo("12381", "1238"));
        System.out.println(f_compareToIgnoreCase("Kot", "koT"));
        System.out.println(f_concat("World"));
        System.out.println(f_len("Kot"));
        ...
        System.out.println(f_sumInt("123"));
    ...
    public static String f_concat(String str) {
        str = "Hello " + str ;
        return str;
    }
